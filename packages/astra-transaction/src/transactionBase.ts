...
import { BN, getAddress, AstraAddress } from '@astra-js/crypto';
import { hexToNumber } from '@astra-js/utils';
import { Messenger, RPCMethod, Emitter, HttpProvider, NewHeaders } from '@astra-js/network';
    ...
    return new Promise((resolve, reject) => {
      ...
      newHeads.then((p) => {
        p.onData(async (data: any) => {
          const blockNumber =
            this.messenger.chainPrefix === 'astra'
