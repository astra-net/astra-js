...
import { toChecksumAddress, randomBytes } from '@astra-js/crypto';
// tslint:disable-next-line: no-implicit-dependencies
...
const msgHttp = new Messenger(http, ChainType.Astra, ChainID.AstraLocal);
// const msgWs = new Messenger(ws, ChainType.Astra, ChainID.AstraLocal);
    ...
    const responses = [
      ...
      },
      {
        ...
        result: {
          ...
          shardID: 0,
          status: '0x1',
          to: '0x13E88a505Dd804971410ac5538C504C376464227',
    ...
    const responses = [
      ...
      },
      {
        ...
        result: {
          ...
          from: '0x6513962Ee39a72093B1fA05f04823c8d70A46D60',
          to: '0x3c02EBfAb0a5eC854d9dAbe1837AEe6C83c0A8ed',
          shardID: 0,
          toShardID: 1,
