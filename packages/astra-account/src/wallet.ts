...
import { bip39, hdkey, EncryptOptions, getAddress, generatePrivateKey } from '@astra-js/crypto';
import { Messenger } from '@astra-js/network';
import { isPrivateKey, isAddress, ChainType } from '@astra-js/utils';
...
class Wallet {
   ...
   * const { HttpProvider, Messenger } = require('@astra-js/network');
   * const { ChainType, ChainID } = require('@astra-js/utils');
   *
   * // create a custom messenger
   * const customMessenger = new Messenger(
   *   new HttpProvider('http://localhost:9500'),
   *   ChainType.Astra, // if you are connected to Astra's blockchain
   *   ChainID.AstraLocal, // check if the chainId is correct
   * )
   *
   * const wallet = new Wallet(customMessenger);
   * ```
  ...
  addByMnemonic(phrase: string, index: number = 0) {
    ...
    // TODO:hdkey should apply to Astra's settings
    const path = this.messenger.chainType === ChainType.Astra ? '1023' : '60';
   ...
   * const key_1 = '45e497bd45a9049bcb649016594489ac67b9f052a6cdf5cb74ee2427a60bf25e';
   * wallet.addByPrivateKey(key_1);
   * wallet.encryptAccount('0xFF9a025FdC0fd4b68Ba4e9Bff46476de15ED8f4D', '12345').then((value) => {
   *   console.log(value);
   * })
   * ```
   */
   ...
   * const key_1 = '45e497bd45a9049bcb649016594489ac67b9f052a6cdf5cb74ee2427a60bf25e';
   * wallet.addByPrivateKey(key_1);
   * wallet.encryptAccount('0xFF9a025FdC0fd4b68Ba4e9Bff46476de15ED8f4D', '12345')
   * .then(() => {
   *   wallet.decryptAccount('0xFF9a025FdC0fd4b68Ba4e9Bff46476de15ED8f4D', '12345')
   *   .then((value) =>{
   *      console.log(value);
   *   });
   * });
   ...
   * const key_1 = '45e497bd45a9049bcb649016594489ac67b9f052a6cdf5cb74ee2427a60bf25e';
   * wallet.addByPrivateKey(key_1);
   * console.log(wallet.getAccount('0xFF9a025FdC0fd4b68Ba4e9Bff46476de15ED8f4D'));
   * ```
   */
