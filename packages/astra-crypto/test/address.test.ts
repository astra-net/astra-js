...
describe('test address', () => {
  it('should test HamonyAddress', () => {
    const hAddress = new AstraAddress(bytes);
    ...
    expect(AstraAddress.isValidBech32(bech32)).toEqual(true);
    expect(AstraAddress.isValidBech32TestNet(bech32Testnet)).toEqual(true);
